...
function generatePassword() {
  ...
  // getting input 
  numberOfCharacters = prompt("How many characters do you want in your password? Choose a numeric value anywhere from 8-128 characters.");
  ...
  // grouping selected characters via concatenation
  if (hasLowercase) {
  ...
  // picking random characters for password length
  let finalPassword = ""
